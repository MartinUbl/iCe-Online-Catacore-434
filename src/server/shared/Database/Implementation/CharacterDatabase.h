...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_MOVE_GUILD_LOWEST_RANK,
    CHAR_MOVE_GUILD_BANK_RIGHT,
    CHAR_MOVE_GUILD_MEMBER,
    ...
    CHAR_SET_GUILD_MEMBER_BANK_TIME_REM_SLOTS6,
    CHAR_SET_GUILD_MEMBER_BANK_TIME_REM_SLOTS7,
    ...
    CHAR_SET_GUILD_MEMBER_BANK_REM_SLOTS6,
    CHAR_SET_GUILD_MEMBER_BANK_REM_SLOTS7,
    ...
    CHAR_RESET_GUILD_RANK_BANK_TIME6,
    CHAR_RESET_GUILD_RANK_BANK_TIME7,
    CHAR_LOAD_GUILDS,
    ...
    CHAR_LOAD_PLAYER_CURRENCY_WEEKCAP,
    ...
    CHAR_LOAD_PLAYER_MONTHLYQUESTSTATUS,

...
enum Spells
{
    ...
    SPELL_BERSERK                               = 47008,    // Ak je chyba tak je tady
        ...
        void DoAction(const int32 action)
        {
            switch (action)
            {
                case ACTION_STEELBREAKER:
                    ...
                    // Toto neviem co urobi ale je to vsade :D

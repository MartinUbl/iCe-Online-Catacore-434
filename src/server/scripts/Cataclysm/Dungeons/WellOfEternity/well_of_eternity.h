...
enum QuestSpells
{
    ...
    SPELL_ARCHIVAL_DEMON_CREDIT         = 109266,
    SPELL_ARCHIVAL_HANDMAIDEN_CHANNEL   = 109270,
...
// Blizzard decided not to use this world states ???
...
enum Actions
{
    ...
    ACTION_HIDE_AND_SEEK_COMPLETED,
    ACTION_HIDE_AND_SEEK_FAILED,
    ...
    ACTION_TYRANDE_START_COMBAT_AFTER_WIPE,

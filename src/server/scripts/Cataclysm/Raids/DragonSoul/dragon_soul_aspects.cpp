...
{
    { -1707.57f, -2387.85f, 340.10f },
    { -1684.49f, -2412.19f, 340.10f },
    { -1690.63f, -2426.18f, 342.74f },
    { -1690.63f, -2426.19f, 342.77f },
};
...
static const Position yseraPos[ASPECTS_MAX_STEPS] =
{
    ...
    { -1684.49f, -2412.19f, 340.10f },
    { -1690.63f, -2426.18f, 342.74f },
    { -1691.19f, -2433.78f, 342.74f },
};

static const Position kalecgosPos[ASPECTS_MAX_STEPS] =
{
    { -1717.11f, -2389.02f, 340.10f },
    { -1711.17f, -2412.43f, 339.75f },
    { -1702.76f, -2424.50f, 342.72f },
    { -1702.34f, -2426.99f, 342.95f },
};
...
static const Position nozdormuPos[ASPECTS_MAX_STEPS] =
{
    { -1717.11f, -2389.02f, 340.10f },
    { -1711.17f, -2412.43f, 339.75f },
    { -1702.12f, -2426.70f, 342.75f },
    { -1699.94f, -2434.31f, 342.72f },
};
...
static const Position thrallPos[ASPECTS_MAX_STEPS] =
{
    { -1717.11f, -2389.02f, 340.10f },
    { -1711.17f, -2412.43f, 339.75f },
    { -1705.48f, -2422.57f, 342.66f },
    { -1696.85f, -2422.11f, 342.79f },
};

        ...
        struct boss_deathbringer_saurfangAI : public BossAI
        {
            ...
            void SpellHitTarget(Unit* target, SpellEntry const* spell)
            {
                switch (spell->Id)
                {
                    ...
                    case 72445:
                    case 72446:
                        if (me->GetPower(POWER_ENERGY) != (int32)me->GetMaxPower(POWER_ENERGY))
...
class spell_deathbringer_blood_link : public SpellScriptLoader
{
    public:
        ...
        class spell_deathbringer_blood_link_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_deathbringer_blood_link_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
    ...
    public:
        ...
        class spell_deathbringer_blood_link_AuraScript : public AuraScript
        {
            ...
            void HandlePeriodicTick(AuraEffect const* /*aurEff*/)
            {
                ...
                if (GetUnitOwner()->getPowerType() == POWER_ENERGY && GetUnitOwner()->GetPower(POWER_ENERGY) == (int32)GetUnitOwner()->GetMaxPower(POWER_ENERGY))
            ...
            void Register()
            {
                OnEffectPeriodic += AuraEffectPeriodicFn(spell_deathbringer_blood_link_AuraScript::HandlePeriodicTick, EFFECT_0, SPELL_AURA_NONE);
            }
        };
    ...
    public:
        ...
        class spell_deathbringer_rune_of_blood_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                if (GetCaster()->GetPower(POWER_ENERGY) != (int32)GetCaster()->GetMaxPower(POWER_ENERGY))
                    GetHitUnit()->CastCustomSpell(SPELL_BLOOD_LINK_DUMMY, SPELLVALUE_BASE_POINT0, 1, GetCaster(), true);
            }

            void Register()
            {
                OnEffect += SpellEffectFn(spell_deathbringer_rune_of_blood_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

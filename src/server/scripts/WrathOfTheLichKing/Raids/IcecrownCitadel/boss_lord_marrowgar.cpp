...
class spell_marrowgar_coldflame : public SpellScriptLoader
{
    public:
        ...
        class spell_marrowgar_coldflame_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_marrowgar_coldflame_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_PERSISTENT_AREA_AURA);
            }
        };
...
class spell_marrowgar_bone_spike_graveyard : public SpellScriptLoader
{
    public:
        ...
        class spell_marrowgar_bone_spike_graveyard_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_marrowgar_bone_spike_graveyard_SpellScript::HandleSpikes, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_marrowgar_bone_storm : public SpellScriptLoader
{
    public:
        ...
        class spell_marrowgar_bone_storm_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffect += SpellEffectFn(spell_marrowgar_bone_storm_SpellScript::RecalculateDamage, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

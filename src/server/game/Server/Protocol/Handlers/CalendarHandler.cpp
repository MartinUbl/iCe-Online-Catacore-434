...
void WorldSession::HandleCalendarGetEvent(WorldPacket& recvData)
{
    ...
    sLog->outDebug("network", "CMSG_CALENDAR_GET_EVENT. Player ["
...
void WorldSession::HandleCalendarGuildFilter(WorldPacket& recvData)
{
    ...
    sLog->outDebug("network", "CMSG_CALENDAR_GUILD_FILTER: Min level [%d], Max level [%d], Min rank [%d]", minLevel, maxLevel, minRank);
}
...
{
    sLog->outDebug("network", "CMSG_CALENDAR_EVENT_INVITE");
...
void WorldSession::HandleCalendarEventSignup(WorldPacket& recvData)
{
    ...
    sLog->outDebug("network", "CMSG_CALENDAR_EVENT_SIGNUP [" UI64FMTD "] EventId [" UI64FMTD "] Tentative %u", guid, eventId, tentative);
...
void WorldSession::HandleSetSavedInstanceExtend(WorldPacket& recvData)
{
    ...
    sLog->outDebug("network", "CMSG_SET_SAVED_INSTANCE_EXTEND - MapId: %u, Difficulty: %u, ToggleExtend: %s", mapId, difficulty, toggleExtend ? "On" : "Off");

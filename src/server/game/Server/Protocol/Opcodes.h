...
enum Opcodes
{
    ...
    CMSG_QUERY_GUILD_XP                              = 0x03129, // 4.0.6a 13623 0x3509 ?
    ...
    SMSG_BATTLEFIELD_MGR_ENTERED                     = 0x0415C, // 4.0.6a 13623
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                = 0x0054C, // 4.0.6a 13623
    CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE       = 0x08108, // 4.0.6a 13623
    CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST               = 0x00611, // 4.0.6a 13623
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE      = 0x00C0C, // 4.0.6a 13623
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING               = 0x0045E, // 4.0.6a 13623
    SMSG_BATTLEFIELD_MGR_EJECTED                     = 0x04C1C, // 4.0.6a 13623
    CMSG_BATTLEFIELD_MGR_EXIT_REQUEST                = 0x08581, // 4.0.6a 13623
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                = 0x0485C, // 4.0.6a 13623
    CMSG_BATTLEFIELD_MGR_LEAVE_REQUEST               = 0x0B6C4, // 4.0.6a 13623
    ...
    CMSG_REDIRECT_AUTH_PROOF                         = 0x10100, // 4.0.6a 13623

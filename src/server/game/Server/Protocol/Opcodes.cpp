...
void InitOpcodeTable()
{
    ...
    OPCODE( SMSG_SPLINE_MOVE_SET_RUN_SPEED,               STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,          STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_SWIM_SPEED,              STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_WALK_SPEED,              STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED,         STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_TURN_RATE,               STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_UNROOT,                      STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_FEATHER_FALL,            STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_NORMAL_FALL,             STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( SMSG_SPLINE_MOVE_SET_LAND_WALK,               STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( CMSG_SET_LFG_COMMENT,                         STATUS_LOGGEDIN, &WorldSession::HandleLfgSetCommentOpcode       );
    ...
    OPCODE( SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,            STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,       STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( CMSG_CALENDAR_EVENT_SIGNUP,                   STATUS_LOGGEDIN, &WorldSession::HandleCalendarEventSignup       );
    ...
    OPCODE( SMSG_CALENDAR_CLEAR_PENDING_ACTION,           STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( SMSG_CALENDAR_RAID_LOCKOUT_UPDATED,           STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CALENDAR_EVENT_INVITE_ALERT,             STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CALENDAR_EVENT_INVITE_NOTES,             STATUS_UNHANDLED,&WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT,       STATUS_UNHANDLED,&WorldSession::Handle_ServerSide               );
    ...
    OPCODE( SMSG_SPLINE_MOVE_SET_PITCH_RATE,              STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_MOVE_ABANDON_TRANSPORT,                  STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CALENDAR_UPDATE_INVITE_LIST,             STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE,   STATUS_LOGGEDIN, &WorldSession::HandleBfEntryInviteResponse     );
    ...
    OPCODE( CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE,   STATUS_LOGGEDIN, &WorldSession::HandleBfQueueInviteResponse     );
    OPCODE( CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST,           STATUS_LOGGEDIN, &WorldSession::HandleBfQueueRequest            );
    ...
    OPCODE( CMSG_BATTLEFIELD_MGR_EXIT_REQUEST,            STATUS_LOGGEDIN, &WorldSession::HandleBfExitRequest             );
    OPCODE( SMSG_BATTLEFIELD_MGR_STATE_CHANGE,            STATUS_NEVER,    &WorldSession::Handle_ServerSide               );
    OPCODE( CMSG_BATTLEFIELD_MGR_LEAVE_REQUEST,           STATUS_LOGGEDIN, &WorldSession::HandleBfExitRequest             );

...
class WorldSession
{
    ...
    public:
        ...
        void SendAuctionCommandResult(AuctionEntry* auction, uint32 Action, uint32 ErrorCode, uint64 bidError = 0);
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleGroupInviteResponseOpcode(WorldPacket &recv_data);
        void HandleGroupUninviteOpcode(WorldPacket& recvPacket);
        void HandleGroupUninviteGuidOpcode(WorldPacket& recvPacket);
        void HandleGroupSetLeaderOpcode(WorldPacket& recvPacket);
        void HandleGroupDisbandOpcode(WorldPacket& recvPacket);
        void HandleGroupSetRoles(WorldPacket & recvPacket);
        void HandleClearRaidMarker(WorldPacket &recv_data);
        ...
        void HandleGuildRequestChallenges(WorldPacket& recvPacket);
        ...
        void HandleRequestHotFixOpcode(WorldPacket& recvPacket);
        ...
        void HandleUnlearnSpecialization(WorldPacket& recvPacket);
        ...
        void HandlePetActionHelper(Unit *pet, uint64 guid1, uint32 spellid, uint16 flag, uint64 guid2, float pos_x, float pos_y, float pos_z);
        ...
        void HandleRequestRatedBgInfo(WorldPacket& recv_data);
        ...
        void SendLfgUpdateStatus(const LfgUpdateData& updateData);

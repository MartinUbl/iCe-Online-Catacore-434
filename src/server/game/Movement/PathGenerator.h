...
public:
    ...
    void SetForceSource(float x, float y, float z);
    void UnsetForceSource();
...
private:
    ...
    bool _forceSource;      // forces source position for path generating
    G3D::Vector3 _forcedStartPosition;  // {x, y, z} of forced start position

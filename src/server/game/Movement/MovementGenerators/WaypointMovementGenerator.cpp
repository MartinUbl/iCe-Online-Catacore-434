...
void WaypointMovementGenerator<Creature>::OnArrived(Creature* creature)
{
    ...
    {
        sLog->outDebug("Creature movement start script %u at point %u for " UI64FMTD ".", i_path->at(i_currentNode)->event_id, i_currentNode, creature->GetGUID());
...
bool WaypointMovementGenerator<Creature>::StartMove(Creature* creature)
{
    ...
    bool transportPath = creature->HasUnitMovementFlag(MOVEMENTFLAG_LEVITATING) && creature->GetTransGUID();

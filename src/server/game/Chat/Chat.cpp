...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "eclipse",        SEC_MODERATOR,      false, &ChatHandler::HandleModifyEclipseCommand,       "", NULL },
        ...
        { "currency",       SEC_MODERATOR,      false, &ChatHandler::HandleModifyCurrencyCommand,      "", NULL },
    ...
    static ChatCommand npcCommandTable[] =
    {
        ...
        { "settrigger",     SEC_GAMEMASTER,     false, &ChatHandler::HandleNpcSetTriggerCommand,       "", NULL },
...
//        { "auctions",                    SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadAuctionsCommand,                "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "petreset",       SEC_PLAYER,         true,  &ChatHandler::HandlePetResetCommand,            "", NULL },

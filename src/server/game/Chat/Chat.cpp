...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand gmCommandTable[] =
    {
        ...
        { "dev",            SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleGMDevCommand>,               "", NULL },
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "holypower",      SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleModifyHolyPowerCommand>,     "", NULL },
        { "eclipse",        SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleModifyEclipseCommand>,       "", NULL },
    ...
    static ChatCommand npcCommandTable[] =
    {
        ...
        { "near",           SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleNpcNearCommand>,             "", NULL },
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "krcma_filter",                SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadKrcmaFilterCommand>,            "", NULL },
...
//        { "auctions",                    SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadAuctionsCommand>,                "", NULL },
    ...
    static ChatCommand resetCommandTable[] =
    {
        ...
        { "archaeology",    SEC_GAMEMASTER,      true,  OldHandler<&ChatHandler::HandleResetArchaeologyCommand>,    "", NULL },
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "destroy",        SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleServerDestroyCommand>,       "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "groupgo",        SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleGroupSummonCommand>,         "", NULL },

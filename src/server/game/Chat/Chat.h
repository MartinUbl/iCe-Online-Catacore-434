...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleDebugRatedBGCommand(const char * args);
        ...
        bool HandleGMDevCommand(const char* args);
        ...
        bool HandleReloadKrcmaFilterCommand(const char* args);
...
//        bool HandleReloadAuctionsCommand(const char* args);
        ...
        bool HandleReloadSpellGrandSkillupCommand(const char* args);

...
typedef std::unordered_map<uint16, CreatureBaseStats> CreatureBaseStatsMap;
...
typedef std::map<uint32,uint32> CreatureSpellCooldowns;

// max different by z coordinate for creature aggro reaction
#define CREATURE_Z_ATTACK_RANGE 3

#define MAX_VENDOR_ITEMS 300                                // Limitation raised in 4.x.x item count in SMSG_LIST_INVENTORY
...
class Creature : public Unit, public GridObject<Creature>
{
    public:
        ...
        void _AddCreatureSpellCooldown(uint32 spell_id, uint32 msDuration);
        void _AddCreatureCategoryCooldown(uint32 category, uint32 msDuration);
        ...
        void SetRegeneratingHealth(bool regenerate) { m_regenHealth = regenerate;}

...
enum eUnitFields
{
    ...
    UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER      = OBJECT_END + 0x001E, // Size: 11, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER = OBJECT_END + 0x0023, // Size: 11, Type: FLOAT, Flags: PRIVATE, OWNER
    ...
    UNIT_FIELD_DISPLAYID                      = OBJECT_END + 0x0035, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_MOD_CAST_HASTE                       = OBJECT_END + 0x0043,
...
enum ePlayerFields
{
    ...
    PLAYER_SKILL_INFO_1_1                     = UNIT_END + 0x01E6, // Size: 384, Type: TWO_SHORT, Flags: PRIVATE

    PLAYER_SKILL_LINEID_0                     = UNIT_END + 0x01E6,
    PLAYER_SKILL_STEP_0                       = UNIT_END + 0x0226,
    ...
    PLAYER_EXPLORED_ZONES_1                   = UNIT_END + 0x037B, // Size: 144, Type: BYTES, Flags: PRIVATE
    ...
    PLAYER_FIELD_PVP_MEDALS                   = UNIT_END + 0x043A, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_RESEARCH_SITE_1              = UNIT_END + 0x04BD, // Size: 8, Type: TWO_SHORT, Flags: PRIVATE
    PLAYER_PROFESSION_SKILL_LINE_1            = UNIT_END + 0x04C5, // Size: 2, Type: INT, Flags: PRIVATE

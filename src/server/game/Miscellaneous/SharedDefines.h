...
enum SpellAttr1
{
    ...
    SPELL_ATTR1_DONT_DISPLAY_IN_AURA_BAR         = 0x10000000, // 28 aura will not be visible in aura bar
...
enum SpellAttr2
{
    ...
    SPELL_ATTR2_STACK_FOR_DIFF_CASTERS           = 0x00004000, // 14
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_NO_DONE_PCT_DAMAGE_MODS          = 0x20000000, // 29 not set in 3.0.3
...
enum Mechanics
{
    ...
    MECHANIC_GRIP             = 6,
    MECHANIC_ROOT             = 7,
    MECHANIC_SLOW_ATTACK      = 8,                          // 0 spells use this mechanic directly, but effects do (i.e. Infected Wounds, Frost Fever, ..)
    MECHANIC_SILENCE          = 9,
    MECHANIC_SLEEP            = 10,
    MECHANIC_SNARE            = 11,
    MECHANIC_STUN             = 12,
...
#define IMMUNE_TO_MOVEMENT_IMPAIRMENT_AND_LOSS_CONTROL_MASK (\
    ...
    (1<<MECHANIC_ROOT)|(1<<MECHANIC_SLEEP)| \
    ...
    (1<<MECHANIC_DAZE)|(1<<MECHANIC_SAPPED) | (1 << MECHANIC_SILENCE) | (1 << MECHANIC_DISARM))
...
enum SpellPreventionType
{
    ...
    SPELL_PREVENTION_TYPE_UNK0      = 3, // Only a few spells have this, but most of the should be interruptable.
    SPELL_PREVENTION_TYPE_UNK1      = 4,
};
...
enum GameObjectDynamicLowFlags
{
    ...
    GO_DYNFLAG_LO_STOPPED           = 0x10,                 // flag for stopped transport (or any animated object which supports that)
};
...
enum Emote
{
    ...
    EMOTE_STATE_READY2H_ALLOW_MOVEMENT = 505,
...
enum CreatureTypeFlags
{
    ...
    CREATURE_TYPEFLAGS_UNIT_IS_QUEST_BOSS                   = 0x80000000
};

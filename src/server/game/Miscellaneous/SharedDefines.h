...
enum SpellAttr7
{
    ...
    SPELL_ATTR7_CAN_BE_KICKED                    = 0x00010000, // 16 Probably used for spells, that can be interrupted via physical interrupts like Kick (rogue)

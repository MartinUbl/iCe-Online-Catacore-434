...
enum AchievementCriteriaTypes
{
    ...
    ACHIEVEMENT_CRITERIA_TYPE_GUILD_CHALLENGE_SPECIFIC = 138,
    ACHIEVEMENT_CRITERIA_TYPE_GUILD_CHALLENGE_GENERIC = 139,
...
enum AchievementCriteriaMoreReqType
{
    ...
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_PLAYER_RACE2           = 25,
    ...
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MAX_GROUP_SIZE         = 29,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_CREATURE_TYPE          = 30,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MAP_ID                 = 32,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_CLASS             = 33,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_SUBCLASS          = 34,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TIMED_QUEST            = 35,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_PERSONAL_RATING_ABOVE  = 37,
    ...
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_FIRST_AID_BELOW        = 46,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ACHIEVEMENT_POINTS_COUNT= 56,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_GUILD_GROUP            = 61,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_GUILD_REP              = 62,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_FRAGMENT_QUALITY       = 65, // common = 0, rare = 1
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_FRAGMENT_TYPE          = 66, // used to recognize research branch
};

enum AchievementProfessionType
{
    ACHIEVEMENT_PROFESSION_TYPE_ALCHEMY = 3,
    ACHIEVEMENT_PROFESSION_TYPE_COOKING = 5,
    ACHIEVEMENT_PROFESSION_TYPE_MINING = 7,
    ACHIEVEMENT_PROFESSION_TYPE_FISHING = 8,
    ACHIEVEMENT_PROFESSION_TYPE_HERBALISM = 9,
};
...
enum MapFlags                                               // Map flags (need more research)
{
    ...
    MAP_FLAG_VARIABLE_DIFFICULTY = 0x00000100               // maps with changeable difficulty
};
...
#define DB2TYPE_ITEM                  1344507586 // hash of item.db2
#define ITEM_TEMPLATE_UPDATE_REGISTER 1091717232 // what is this for?

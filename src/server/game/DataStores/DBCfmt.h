...
const char True_SpellEntryfmt[]=      "iiiiiiiiiixiiiifiiiisxxxiixxixiiiiiiixiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiifffiiiiiiiiiiiiiiiiiifffiiifffiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffffffiiiiiiiiiii";
const std::string CustomSpellEntryIndex = "Id";
const char SpellEntryfmt[]=           "niiiiiiiiixiiiifiiiisxxxiixxixiiiiiiixiiiiiiiii";

...
const char ResearchProjectsfmt[]="nsxxiiixi";
...
const char True_SpellEntryfmt[]=      "iiiiiiiiiixiiiifiiiisixxiixxixiiiiiiixiiiiixiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiifffiiiiiiiiiiiiiiiiiifffiiifffiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffffffiiiiiiiiiii";
const std::string CustomSpellEntryIndex = "Id";
const char SpellEntryfmt[]=           "niiiiiiiiixiiiifiiiisixxiixxixiiiiiiixiiiiixiii";

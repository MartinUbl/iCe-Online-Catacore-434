...
const char True_SpellEntryfmt[]=      "iiiiiiiiiixiiiifiiiisxxxiixxifiiiiiiixiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiifffiiiiiiiiiiiiiiiiiifffiiifffiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffffffiiiiiiiiiii";
const std::string CustomSpellEntryIndex = "Id";
const char SpellEntryfmt[]=           "niiiiiiiiixiiiifiiiisxxxiixxifiiiiiiixiiiiiiiii";

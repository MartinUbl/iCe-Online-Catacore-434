...
bool BattlegroundRV::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_RV_OBJECT_BUFF_1, BG_RV_OBJECT_TYPE_BUFF_1, 735.551819f, -284.794678f, 28.276682f, 0.034906f, 0, 0, 0, 0, SHADOWSIGHT_RESPAWN_TIME)
        || !AddObject(BG_RV_OBJECT_BUFF_2, BG_RV_OBJECT_TYPE_BUFF_2, 791.224487f, -284.794464f, 28.276682f, 2.600535f, 0, 0, 0, 0, SHADOWSIGHT_RESPAWN_TIME)
    // fire

...
bool BattlegroundRL::GetUnderMapReturnPosition(Player* plr, Position& pos)
{
    pos.Relocate(1285.810547f, 1667.896851f, 39.957642f, plr->GetOrientation());
    return true;
}
...
bool BattlegroundRL::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_RL_OBJECT_BUFF_1, BG_RL_OBJECT_TYPE_BUFF_1, 1328.719971f, 1632.719971f, 36.730400f, -1.448624f, 0, 0, 0.6626201f, -0.7489557f, SHADOWSIGHT_RESPAWN_TIME)
        || !AddObject(BG_RL_OBJECT_BUFF_2, BG_RL_OBJECT_TYPE_BUFF_2, 1243.300049f, 1699.170044f, 34.872601f, -0.06981307f, 0, 0, 0.03489945f, -0.9993908f, SHADOWSIGHT_RESPAWN_TIME))
    {

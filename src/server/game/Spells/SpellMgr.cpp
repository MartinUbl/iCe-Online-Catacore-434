...
int32 SpellMgr::CalculateSpellEffectAmount(SpellEntry const * spellEntry, uint8 effIndex, Unit const * caster, int32 const * effBasePoints, Unit const * target)
{
    ...
    if (caster)
    {
        ...
        if (!basePointsPerLevel && (spellEntry->Attributes & SPELL_ATTR0_LEVEL_DAMAGE_CALCULATION && spellEntry->spellLevel) &&
            ...
            spellEntry->Effect[effIndex] != SPELL_EFFECT_WMO_DAMAGE &&
...
/*************************        DRAGON SOUL END        *****************************/
        ...
        case 109840:
            ...
            spellInfo->AttributesEx &= ~SPELL_ATTR4_NOT_USABLE_IN_ARENA;
            count++;
            break;
...
/**********************------- END TIME 5 MAN DUNGEON -------**********************/
        ...
        case 101842: // Moonlit
            ...
            spellInfo->EffectImplicitTargetB[1] = TARGET_NONE;
            break;
        case 102491: // Tyrande achievement tracker
            spellInfo->EffectImplicitTargetA[0] = TARGET_UNIT_CASTER;
            spellInfo->EffectImplicitTargetB[0] = TARGET_NONE;
            break;
        // Echo of Jaina
...
/********************-------- WELL OF ETERNITY END -----------********************/
        ...
        case 76717: case 93668:                 // Meteor (BoT)
        ...
        case 33206: // Pain Suppression
            ...
            count++;
            break;
        case 86664: // Soulburn: Seed of Corruption (bad dbc data) -> hate you blizzard
            spellInfo->Effect[EFFECT_0] = SPELL_EFFECT_APPLY_AURA;
            spellInfo->EffectApplyAuraName[EFFECT_0] = SPELL_AURA_DUMMY; 
            break;

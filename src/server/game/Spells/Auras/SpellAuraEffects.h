...
class AuraEffect
{
    ...
    public:
        ...
        void HandleAuraModIncreaseSpeedSpecial(AuraApplication const * aurApp, uint8 mode, bool apply) const;
        //  immunity
        ...
        void HandleModOverrideSpellPowerByAttackPowerPercent(AuraApplication const * aurApp, uint8 mode, bool apply) const;

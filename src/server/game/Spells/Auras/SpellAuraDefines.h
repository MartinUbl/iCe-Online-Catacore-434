...
enum AuraType
{
    ...
    SPELL_AURA_MOD_DAMAGE_MECHANIC = 276,
    ...
    SPELL_AURA_MOD_CRITICAL_CHANCE_SPECIFIC = 308,
    SPELL_AURA_309 = 309,
    ...
    SPELL_AURA_MOD_MELEE_SPEED_PCT = 319,
    SPELL_AURA_MOD_RANGED_SPEED_PCT = 320,
    SPELL_AURA_321 = 321,
    ...
    SPELL_AURA_325 = 325,
    SPELL_AURA_326 = 326,
    SPELL_AURA_327 = 327, //doesn't exist
    SPELL_AURA_DRIVER_PASSIVE = 328,
    SPELL_AURA_MOD_RUNIC_POWER_FROM_DAMAGE_DEALT = 329,
    SPELL_AURA_WALK_AND_CAST = 330,
    SPELL_AURA_FORCE_WEATHER = 331,
    SPELL_AURA_MOD_ACTION_BUTTON = 332,
    SPELL_AURA_MOD_ACTION_BUTTON_2 = 333,
    SPELL_AURA_334 = 334,
    SPELL_AURA_MOD_INCREASE_SPEED_SPECIAL = 335,
    SPELL_AURA_MOD_MOUNT_TYPE = 336,
    SPELL_AURA_MOD_VENDOR_COST = 337,
    SPELL_AURA_MOD_DURABILITY_LOSS = 338,
    SPELL_AURA_MOD_SKILLGAIN_CHANCE = 339,
    SPELL_AURA_MOD_RESURRECT_STATS = 340,
    SPELL_AURA_MOD_COOLDOWN_NATIVE = 341,
    SPELL_AURA_342 = 342,
    SPELL_AURA_MOD_AUTOATTACK_DAMAGE_1 = 343,
    SPELL_AURA_MOD_AUTOATTACK_DAMAGE_2 = 344,
    SPELL_AURA_BYPASS_ARMOR = 345,
    SPELL_AURA_DISPLAY_PROGRESS_BAR = 346,
    SPELL_AURA_HASTE_MOD_COOLDOWN = 347,
    SPELL_AURA_MOD_LOOT_MONEY_GAIN = 348,
    SPELL_AURA_MOD_CURRENCY_GAIN = 349,
    SPELL_AURA_MOD_GATHER_QUANTITY = 350,
    SPELL_AURA_351 = 351,
    SPELL_AURA_352 = 352,
    ...
    SPELL_AURA_356 = 356,
    SPELL_AURA_357 = 357,
    SPELL_AURA_TRANSFORM_2 = 358,
    SPELL_AURA_359 = 359,
    SPELL_AURA_360 = 360,
    SPELL_AURA_361 = 361,
    SPELL_AURA_362 = 362,
    SPELL_AURA_MOD_NEXT_SPELL = 363, // Only one spell ( 101601 Throw Totem )
    SPELL_AURA_364 = 364,
    SPELL_AURA_365 = 365,
